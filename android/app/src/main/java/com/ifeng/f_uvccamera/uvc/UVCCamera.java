...
package com.ifeng.f_uvccamera.uvc;
...
import com.ifeng.f_uvccamera.usb.UsbController;
...
public class UVCCamera {
    ...
    public static final int DEFAULT_PREVIEW_MIN_FPS = 5;
     ...
     * @param controlBlock
     */
    public synchronized int open(final UsbController controlBlock) {
        int result = -1;
        int retryCout = 3;
        try {
            mControlBlock = controlBlock;
            while (result < 0 && retryCout > 0) {
        ...
        return nativeSetPreviewSize(mNativePtr, DEFAULT_PREVIEW_WIDTH, DEFAULT_PREVIEW_HEIGHT,

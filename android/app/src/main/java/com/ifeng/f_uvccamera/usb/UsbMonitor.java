package com.ifeng.f_uvccamera.usb;
...
public class UsbMonitor implements IMonitor {
    ...
    @Override
    public void checkDevice() throws CameraAccessException{
        ...
        if (isTargetDevice(usbDevice) && mConnectCallback != null) {
            ...
            throw new CameraAccessException(CameraAccessException.CAMERA_ERROR, "没有找到USB Camera，请检查是否被占用");
        }
    }
    ...
    public void requestPermission(UsbDevice usbDevice) {
        ...
        if (mUsbManager.hasPermission(usbDevice)) {
            ...
            PendingIntent mPermissionIntent = PendingIntent.getBroadcast(mContext, 0,
                    ...
                    android.os.Build.VERSION.SDK_INT>=34? PendingIntent.FLAG_IMMUTABLE:PendingIntent.FLAG_MUTABLE);
    ...
    public boolean isUsbCamera(UsbDevice usbDevice) {
        return usbDevice != null
                && 239 == usbDevice.getDeviceClass()
                && 2 == usbDevice.getDeviceSubclass();
    }
